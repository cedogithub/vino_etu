...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  PRIMARY KEY (`uti_id`),
  INDEX `fk_utilisateur_role_idx` (`uti_rol_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bouteille` (
  ...
  PRIMARY KEY (`bout_id`),
  INDEX `fk_bouteille_type_idx` (`bout_type_id` ASC) VISIBLE,
  UNIQUE INDEX `bout_code_saq_UNIQUE` (`bout_code_saq` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cellier` (
  ...
  PRIMARY KEY (`cel_id`),
  INDEX `fk_cellier_table11_idx` (`cel_uti_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bouteille_du_cellier` (
  ...
  PRIMARY KEY (`bdc_cel_id`, `bdc_bout_id`),
  INDEX `fk_cellier_has_bouteille_bouteille1_idx` (`bdc_bout_id` ASC) VISIBLE,
  INDEX `fk_cellier_has_bouteille_cellier1_idx` (`bdc_cel_id` ASC) VISIBLE,
